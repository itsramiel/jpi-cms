...
export interface ApiMessageMessage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    contactInfo: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    coordinates: Attribute.Component<'coordinates.coordinates'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    amenities: Attribute.Relation<
      ...
      'api::amenity.amenity'
    >;
    nearbyPOI: Attribute.Component<'nearby-poi.nearby-poi', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    underConstruction: Attribute.Boolean &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    >;
    downPaymentPercentage: Attribute.Integer &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    fullPaymentDiscount: Attribute.Boolean &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
